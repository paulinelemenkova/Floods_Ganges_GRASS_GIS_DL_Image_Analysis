...
r.import input=/Users/polinalemenkova/grassdata/Bangladesh/LC08_L2SP_137044_20220320_20220329_02_T1_SR_B1.TIF output=L8_2022_M_01 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Bangladesh/LC08_L2SP_137044_20220320_20220329_02_T1_SR_B2.TIF output=L8_2022_M_02 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Bangladesh/LC08_L2SP_137044_20220320_20220329_02_T1_SR_B3.TIF output=L8_2022_M_03 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Bangladesh/LC08_L2SP_137044_20220320_20220329_02_T1_SR_B4.TIF output=L8_2022_M_04 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Bangladesh/LC08_L2SP_137044_20220320_20220329_02_T1_SR_B5.TIF output=L8_2022_M_05 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Bangladesh/LC08_L2SP_137044_20220320_20220329_02_T1_SR_B6.TIF output=L8_2022_M_06 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Bangladesh/LC08_L2SP_137044_20220320_20220329_02_T1_SR_B7.TIF output=L8_2022_M_07 extent=region resolution=region
#
g.list rast
...
d.legend raster=L8_2022_M_cluster_classes title="20 March 2022" title_fontsize=14 font="Helvetica" fontsize=12 bgcolor=white border_color=white
d.out.file output=Bangladesh_2021_mar format=jpg --overwrite
# Mapping rejection probability
d.mon wx1
g.region raster=L8_2022_M_cluster_classes -p
r.colors L8_2022_M_cluster_reject color=rainbow -e
d.rast L8_2022_M_cluster_reject
d.legend raster=L8_2022_M_cluster_reject title="20 March 2022" title_fontsize=14 font="Helvetica" fontsize=12 bgcolor=white border_color=white
d.out.file output=Bangladesh_2022_M_reject format=jpg --overwrite
#--------------------------------------------->
# MACHINE LEARNING
g.region raster=L8_2022_M_01 -p
# Generate training pixels from an older land cover classification:
r.random input=L8_2022_M_cluster_classes seed=100 npoints=1000 raster=training_pixels --overwrite
...
r.learn.train group=L8_2022_M training_map=training_pixels \
    model_name=MLPClassifier n_estimators=500 save_model=mlpc_model.gz --overwrite
# perform prediction using r.learn.predict
r.learn.predict group=L8_2022_M load_model=mlpc_model.gz output=rf_classification --overwrite
...
d.out.file output=MLPC_2022_03 format=jpg --overwrite
